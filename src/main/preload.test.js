...
describe('preload', () => {
  ...
  test('exposes the preload bridges and routes direct wrappers to ipcRenderer', async () => {
    ...
    const invokeCases = [
      ...
      [exposures.myotis, 'retryCheckpoint', [100], IPC.MYOTIS_RETRY_CHECKPOINT, [100]],
      [exposures.myotis, 'repairSyncData', [100], IPC.MYOTIS_REPAIR_SYNC_DATA, [100]],
      [exposures.myotis, 'recoveryHelp', [100], IPC.MYOTIS_RECOVERY_HELP, [100]],
